...
Write-Host " Gerando Certificados SSL para todos os servios..." -ForegroundColor Green
...
# Verificar se OpenSSL est disponvel
try {
...
Write-Host " Certificado vlido para: localhost" -ForegroundColor Yellow